...
<body class="hold-transition lockscreen">
	...
	<div class="lockscreen-wrapper">
		<div class="lockscreen-logo">
			<a href="<?php echo (base_url('Welcome/index')) ?>">Login
				<b>Administrator</b></a>
		</div>
		<!-- User name -->
		<div class="lockscreen-name"><?php echo ($this->session->userdata("login_name")) ?></div>
		...
		<div class="lockscreen-item">
			...
			<div class="lockscreen-image">
				<img src="assets/dist/img/user.png" alt="User Image">
			</div>
			<!-- /.lockscreen-image -->

			<!-- lockscreen credentials (contains the form) -->
			<form class="lockscreen-credentials" action="<?php echo (base_url('Welcome/login_auth')) ?>" method="POST">
		...
		<div class="text-center">
			<a href="<?php echo (base_url('Welcome/login')) ?>">Atau gunakan akun lain.</a>
		</div>
